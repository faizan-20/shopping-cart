    ...
    return (
        ...
        >
            ...
            <div className="text text-white mt-8 text-xl flex justify-between items-center w-96">
                ...
                <Link to="/shopping-cart/shop" className=" rounded-md border-white-200 border-2 px-2 py-1 text-slate-200 font-bold hover:bg-slate-200 hover:text-slate-900 transition duration-200">Shop Now</Link>
            </div>
        </div>
    )
}
